        ...
        <Card data-aos="zoom-in" className="cardBackground">
          <Card.Body className="cardBackground">
            ...
            <Card.Text className="menuItems">
              <p>
              The Big Ben 8oz/12oz{" "}
                <span className="priceDetails">
                  --- Filet Mignon center cut 8oz/12oz <span>( $50/62)</span>
                </span>
              </p>

              <p>
              The Jimmie Sacco Steak 26oz{" "}
                <span className="priceDetails">
              ...
              <p>
              The T.J. Watt Steak 22oz{" "}
                <span className="priceDetails">
                  --- Porterhouse, filet & strip in one, 21-day dry aged Black Angus Creekstone Farms <span>( $76)</span>
                </span>
              </p>
              <p>
              Steak Shelton, 16oz{" "}
              ...
              Steak Lemieux 14oz{" "}
                <span className="priceDetails">
                  ---New York Strip topped with roasted cloves of garlic & mushrooms<span> ($59)</span>
                </span>
              </p>
              <p>
              Steak Rooney 8oz/12oz{" "}
                <span className="priceDetails">
        ...
        <Card data-aos="zoom-in" className="cardBackground">
          <Card.Body className="cardBackground">
            ...
            <Card.Text className="menuItems">
              ...
              <p>
              Polamalu's Lobster Tail 12oz-14oz{" "}
                <span className="priceDetails">
                  ---
                  <span> 72</span>
                </span>
