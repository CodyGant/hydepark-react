...
function INDIANAPOLISEARLY() {
  return (
    <div className="menuPage">
      ...
      <p>
        Available Nightly Until 6pm - Not Available on Holidays -
      </p>
      <h3>
      ...
      <div className="menuBottom">
          <h1> A 20% Gratuity Is Added for Groups of 7 or More</h1>
        <h3>
...
export default INDIANAPOLISEARLY;
